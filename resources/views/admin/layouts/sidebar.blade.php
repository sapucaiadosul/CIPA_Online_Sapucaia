                ...
                <div class="sidebar-content">
                    <ul class="nav nav-primary">
                        ...
                        <li class="nav-item {{ (request()->is('Candidato_Create')) || (request()->is('Candidato_Listar'))  ? 'active' : '' }}">
                            ...
                            <div class="expandable collapse {{ (request()->routeIs('')) || (request()->routeIs('')) || (request()->routeIs('Candidato_Create')) ? 'show' : '' }}" aria-controls="collapseOne" id="base">
                                <ul class="nav nav-collapse ">
                                    ...
                                    <a href="{{ route('Candidato_ListagemGeral') }}">
                                        <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                                        <span class="sub-item">Listagem Geral de Candidatos</span>
                                    </a>
                                </ul>
                            </div>
                        </li>
                            ...
                            <div class="expandable collapse" id="sidebarLayouts">
                                <ul class="nav nav-collapse">
                                    ...
                                    <a href="{{ route('Votacao_Resultados') }}">
                                        <i class="fa fa-list-ul" aria-hidden="true"></i>
                                        <span class="sub-item">Resultados Externos</span>
                                    </a>
                                </ul>
                            </div>
                        </li>
